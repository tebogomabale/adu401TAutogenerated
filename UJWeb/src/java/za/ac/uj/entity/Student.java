...
@NamedQueries({
    ...
    , @NamedQuery(name = "Student.findByInstitutionId", query = "SELECT s FROM Student s WHERE s.institutionId = :institutionId")})
public class Student implements Serializable {
    ...
    public Student(Integer studentId, int idnumber, int institutionId) {
        this.studentId = studentId;
    ...
    public String toString() {
        return "za.ac.uj.entity.Student[ studentId=" + studentId + " ]";
    }
